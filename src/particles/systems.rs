...
use crate::particles::{
    components::{EmissionShape, Particle, ParticleConfig, ParticleEmitter},
...
pub fn spawn_particles(
    ...
    let mid_color = Color::LinearRgba(LinearRgba::new(
        linear.red * 0.7,
        linear.green * 0.7,
        linear.blue * 0.7,
        0.0,
    ));
    let end_color = Color::LinearRgba(LinearRgba::new(
        linear.red * 0.3,
        linear.green * 0.3,
        linear.blue * 0.3,
        0.0,
